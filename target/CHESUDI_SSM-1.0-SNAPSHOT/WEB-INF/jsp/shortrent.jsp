        ...
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav" id="daohang">
                <label data-v-67ef3a4a v-if="weidenglu">
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/loginJsp" class="colorRed" >登录</a>
                    <a data-v-67ef3a4a href="" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/registerJsp" class="colorRed" style="margin-right: 10px;">注册</a>
                </label>

                <label data-v-67ef3a4a v-if="denglu">
                    <a data-v-67ef3a4a href="#">你好，</a>
                    <a data-v-67ef3a4a href="#" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/exit" class="colorRed" style="margin-right: 10px;">[退出]</a>
                </label>
            ...
            <div data-v-67ef3a4a="" class="right phone">
                ...
                <div data-v-67ef3a4a="" class="menu">
                    <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/middle">我的车速递</a>
                </div>
                <div data-v-67ef3a4a="">
    ...
    <div data-v-39f7f629 class="csdnav">
        <div data-v-39f7f629="" class="layout clear">
            <div data-v-39f7f629="" class="left logo">
                <a data-v-39f7f629="" href="${pageContext.request.contextPath}/indexJsp">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/shortrentJsp" target="_self" class="colorRed">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/indexJsp" target="_self" >
...
<script type="text/javascript">
    ...
    function loadfirst(pid){
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/city/selectPid?pid="+pid,
            dataType:"json",
...
<script type="text/javascript">
    ...
    function selectCar() {
        var getid = $("#bmsel").val();
        var backid = $("#hcs").val();
        window.location.href="${pageContext.request.contextPath}/shortsortJsp?getid="+getid+"&backid="+backid;
