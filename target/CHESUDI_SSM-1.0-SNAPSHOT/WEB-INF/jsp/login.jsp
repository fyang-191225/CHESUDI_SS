                    ...
                    <div class="forms">
                        <form class="layui-form" method="post">
                            ...
                            <div data-v-0a99943a="" class="goRegister">
                                还没有账号？<a data-v-0a99943a="" href="${pageContext.request.contextPath}/registerJsp">免费注册</a></div>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(dt){
            $.ajax({
                url:"${pageContext.request.contextPath}/user/loginDo",
                type:"post",
                data:$("form").serialize(),
                dataType:'json',
                success:function(data) {
                    if(data.code == 1) {
                        alert(data.info);
                        window.location.href="${pageContext.request.contextPath}/loginsuccessJsp";
                    }else {
                        alert(data.info);
                    }
                },
