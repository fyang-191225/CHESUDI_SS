...
<div id="app" class="bgGray">
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            </div> <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/order/mymainJsp?id=${currentUser.id}">我的订单</a>|<a data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/exit">退出</a>
        </div>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/order/mymainJsp?id=${currentUser.id}" class="sel">订单管理</a>
                            </li>
                             <li data-v-1cae2c34="">
                                 <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/myinfoJsp?tel=${currentUser.tel}" class="">个人信息</a>
                             </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="orderList list">
                            <div class="orderListCom listCom" style="position: static;">
                                ...
                                <div class="noData" id="noda">
                                    ...
                                    <table cellspacing="0" cellpadding="0">
<%--                                      //  <c:forEach items="${user1}" var="site">--%>
                                        <tr class="firstTr" v-for="site in obj">
                                            ...
                                            <td>{{site.backcity}}</td>
                                            <td>{{site.ostatus}}</td>
                                            <td><a v-bind:href="'${pageContext.request.contextPath}/order/delete?id='+site.oid" style="color:red">删除</a></td>
...
<script type="text/javascript">
    ...
    function loadData(page) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/order/selectOrder?page="+page,
            dataType:"json",
            async: false,
