    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30=""
                                                                 href="${pageContext.request.contextPath}/order/mymainJsp/">我的订单</a>|<a
                    data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30=""
                                                                          href="${pageContext.request.contextPath}/exit">退出</a></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "${pageContext.request.contextPath}/car/getByCar" + getid,
            dataType: "json",
            success: function (data) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 2) {
                    ...
                    window.location.href = "${pageContext.request.contextPath}/order/mymainJsp";
