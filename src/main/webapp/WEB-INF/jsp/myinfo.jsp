    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            <div data-v-95ac8d30="" class="left logo">
                <a data-v-95ac8d30="" href="${pageContext.request.contextPath}/indexJsp">
            ...
            </div> <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/orderManageJsp">我的订单</a>|<a data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/exit">退出</a>
        </div>
            <div data-v-95ac8d30="" class="header3User right">
                ...
                <span data-v-95ac8d30="" class="sp2">欢迎您${currentUser.tel}</span>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/order/mymainJsp" class="">订单管理</a>
                            </li>
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/myinfoJsp?tel=${currentUser.tel}" class="sel">个人信息</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.code==1){
                    ...
                    vm.password=data.info.password;
        ...
        var active = {
            ...
            ,offset: function(othis){
                ...
                layer.open({
                    ...
                    ,content: '<div align="center" style="width: 300px; height: 200px;">请输入密码：<br><form ><input type="password" name="password" id="password"> <br><请输入修改后的手机号：<br><input type="text" name="tel" id="tel"></form></div>'
                    ,btn: '修改'
                    ,btnAlign: 'c' //按钮居中
                    ,shade: 0 //不显示遮罩
                    ,yes: function(){
                        $.ajax({
                            ...
                            success:function(data) {
                                if(data.code == 1) {
                                    alert("修改成功！");
                                    window.location.href="${pageContext.request.contextPath}/myinfoJsp";
                                } else if(data.code == 0) {
                                    alert(data.info);
                                }
                            },
