   ...
   var vm2 = new Vue({
       ...
       methods:{
         selectCar:function (id) {
             window.location.href="${pageContext.request.contextPath}/orderSubmitJsp"+getid +"&cid=" +id;
         }
       },
...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/car/getByprice"+getid,
            dataType:"json",
            success:function(data){
                if(data.code==1) {
                    vm2.sites = data.info;
...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/car/getByNum"+getid,
            dataType:"json",
            success:function(data){
                if(data.code==1) {
                    vm3.cars = data.info;
