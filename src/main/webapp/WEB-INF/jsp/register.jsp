    ...
    <div data-v-95c8bc32="" data-v-676ecf83="" class="header2">
        <div data-v-95c8bc32="" class="layout clear">
            <div data-v-95c8bc32="" class="left logo">
                <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/indexJsp">
                    <img data-v-95c8bc32=""
            ...
            <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/indexJsp" class="right">回到首页&gt;</a>
        </div>
    </div>
            ...
            <div data-v-676ecf83="" class="registerCom clear">
                <div data-v-676ecf83="" class="registerType left">
                    ...
                    <form class="layui-form" method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input id="tel1" type="tel" name="tel" lay-verify="required|phone" placeholder="请输入手机号"
                                           autocomplete="off" class="layui-input"><span id="tel2"></span>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <i id="fyy" hidden class="layui-icon layui-icon-rate" style="font-size: 20px; "></i>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <span style="align-content: center; font-size: 20px;  color: black; width: 25px; height: 10px"
                                          id="msg" onclick="send()||bad()"></span>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div data-v-676ecf83="" class="registerImg right">
                    <h2 data-v-676ecf83="">已有车速递账号？
                        <a data-v-676ecf83="" href="${pageContext.request.contextPath}/loginJsp">立即登录&nbsp;&gt;&gt;</a>
                    </h2> <img data-v-676ecf83="" src="https://www.chesudi.com/static/img/register.be4a5bd.jpg">
                </div>
            </div>
...
<script>
    ...
    <%--        var th =$("#tel1").val()--%>
    <%--        $.ajax({--%>
    <%--            url: "${pageContext.request.contextPath}/user/tel?tel="+th,--%>
    <%--            type: "get",--%>
    <%--            dataType: 'json',--%>
    ...
    function send() {
        var th = $("#email").val();
        $.ajax({
            url: "${pageContext.request.contextPath}/emailController/mail?email=" + th,
            type: "get",
            dataType: 'json',
            success: function (data) {
                if (data == 1) {
        ...
        form.on('submit(demo1)', function (data) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 1) {
                        alert("注册成功！");
                        window.location.href = "${pageContext.request.contextPath}/loginJsp";
                    } else {
                        alert(data.info);
                    }
                },
